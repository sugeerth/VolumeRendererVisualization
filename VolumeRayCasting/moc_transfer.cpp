...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Transfer_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Transfer_t qt_meta_stringdata_Transfer = {
    {
QT_MOC_LITERAL(0, 0, 8),
QT_MOC_LITERAL(1, 9, 32),
QT_MOC_LITERAL(2, 42, 0)
    },
    "Transfer\0on_Sendingtransfervalues_clicked\0"
    ""
};
...
void Transfer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->on_Sendingtransfervalues_clicked(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject Transfer::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Transfer.data,
      qt_meta_data_Transfer,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Transfer.stringdata))
